...
using TriJasa.Blazor.Server.Services;

namespace TriJasa.Blazor.Server {
    public partial class TriJasaBlazorApplication : BlazorApplication {
        public TriJasaBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TriJasaBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
