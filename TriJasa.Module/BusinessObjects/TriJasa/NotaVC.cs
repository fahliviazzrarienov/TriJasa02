...
namespace TriJasa.Module.BusinessObjects
{
    ...
    public partial class NotaVC : ViewController
    {
        ...
        private void UnlinkAction_Executed(object sender, ActionBaseEventArgs e)
        {
            ...
            foreach (Nota selectedObject in unlinkedItems)
            {
                selectedObject.PmtDiterima = 0;
                selectedObject.PmtAdjutment = 0;
                selectedObject.PmtPotongan = 0;
        ...
        private void ObjectSpace_ObjectChanged(object sender, ObjectChangedEventArgs e)
        {
            try
            {
                if (View != null)
                {
                    ...
                    //if ( View.Id== "NotaPayment_ListNota_ListView_Entry" && e.Object !=null)
                    //{
                    //    if (this.ObjectSpace.IsModified)
                    //    {
                    //        try
