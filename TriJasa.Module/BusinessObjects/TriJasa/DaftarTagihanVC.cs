...
namespace TriJasa.Module.BusinessObjects.TriJasa
{
    ...
    public partial class DaftarTagihanVC : ViewController
    {
        public DaftarTagihanVC()
        {
            ...
            ChoiceActionItem DTPPrint04 = new ChoiceActionItem("DTPPrint04", "Rekap Daftar Tagih List Nota", null);
            ...
            DTPrintAction.Items.Add(DTPPrint04);
        ...
        private void DTPrintAction_Execute(object sender, SingleChoiceActionExecuteEventArgs e)
        {
            ...
            else if (e.SelectedChoiceActionItem.Id == "DTPPrint04")
            {

                oCriteria = null;
                ReportName = oGen.ReportNameGet(objectSpace, "DTPPrint04");
                PrintReports(ReportName, oCriteria);
