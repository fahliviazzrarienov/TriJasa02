...
{ 
   ...
   public class Nota : XPObject
   {
     ...
     [XafDisplayName("Total SM"), ToolTip("Total SM")]
        [ModelDefault("DisplayFormat", "{0:N0}")]
     ...
     [XafDisplayName("Total Nota"), ToolTip("Total Nota")]
        [ModelDefault("DisplayFormat", "{0:N0}")]
     ...
     { 
       ...
       set { SetPropertyValue("Note3", ref _Note3, value); } 
        ...
        private string _FakturPajak;
        [XafDisplayName("FP"), ToolTip("FP")]
        [Size(30)]
        public virtual string FakturPajak
        {
            get { return _FakturPajak; }
            set { SetPropertyValue("FakturPajak", ref _FakturPajak, value); }
        }
        ...
        public virtual eTagihan Status
        {
            get {
                if (!IsLoading && !IsSaving)
                {
                    ...
                    else if (Sisa != TotalBiaya)
                    {
                        _Status = eTagihan.Dibayar;
                    }
                    else if (_Status == eTagihan.Lunas && _Sisa !=0)
                    {
                        _Status = eTagihan.Dibayar;
                    }
                    else if (_Status == eTagihan.Dibayar && _Sisa == 0)
                    {
                        _Status = eTagihan.Diterima;
                    }
        ...
        [XafDisplayName("Klaim Supir"), ToolTip("Klaim Supir")]
        [ModelDefault("DisplayFormat", "{0:N0}")]
        [ImmediatePostData]
        ...
        [ModelDefault("DisplayFormat", "{0:N0}")]
        [PersistentAlias("TotalBiaya- (TelahDiTerima +PmtPotongan+PmtAdjutment+PmtDiterima) ")]
