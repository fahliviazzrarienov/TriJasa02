     ...
     { 
       ...
       set {    SetPropertyValue("Kg", ref _Kg, value);
                ...
                if (!IsLoading && !IsSaving )
                {
                    if (SuratMuat != null)
                    {
                        if (SuratMuat.TarifHarga != null)
                        {
                            if (value > 0)
                            {
                                Ongkos = SuratMuat.TarifHarga.HargaPerKG;
                                OngkosOriginal = SuratMuat.TarifHarga.HargaPerKGOrg;
                            }
                        }
                    }
                    ...
                    if ( SuratMuat !=null )
                      { 
                        if ( SuratMuat.TarifHarga!=null)
                        {
                            if ( value>0)
                            {
                                Ongkos = SuratMuat.TarifHarga.HargaPerM3;
                                OngkosOriginal = SuratMuat.TarifHarga.HargaPerM3Org;
                            }
                        }
                        }
