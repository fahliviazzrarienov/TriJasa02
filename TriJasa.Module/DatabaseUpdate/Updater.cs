...
namespace TriJasa.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            oGen.ReportNameSet(ObjectSpace, "DTPPrint04", "Rekap Daftar Tagih List Nota", "Rekap Daftar Tagih List Nota");
            ...
            oGen.ReportNameSet(ObjectSpace, "BKPrint01", "Rekap Pengeluaran", "Rekap Pengeluaran");


            // SUPIR KLAIM
            oGen.ReportNameSet(ObjectSpace, "SKPPPrint01", "", "Print Supir Klaim");
            oGen.ReportNameSet(ObjectSpace, "SKPPPrint02", "Rekap Klaim Supir", "Print Supir Klaim");

            oGen.ReportNameSet(ObjectSpace, "PelunasanPrint01", "NotaPelunasan", "Laporan Pelunasan");

            oGen.ReportNameSet(ObjectSpace, "SMKPPrint01", "", "Pengajuan Komisi");
            oGen.ReportNameSet(ObjectSpace, "SMKPPrint02", "", "Komisi Status");
            oGen.ReportNameSet(ObjectSpace, "SMKPPrint03", "", "Pembayaran Komisi");

            oGen.ReportNameSet(ObjectSpace, "KasbonPPrint01", "Kartu Kasbon & Klaim", "Kartu Kasbon & Klaim");
            oGen.ReportNameSet(ObjectSpace, "KasbonPPrint02", "Rekap Kasbon & Klaim", "Rekap Kasbon & Klaim");
