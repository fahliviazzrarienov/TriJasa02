...
namespace TriJasa.Module.Web.Controllers
{
    ...
    public partial class GridListViewController : ViewController<ListView>
    {
        public GridListViewController()
        {
            ...
            TargetObjectType = typeof(SuratMuatDtl);
        ...
        protected override void OnViewControlsCreated()
        {
            ...
            try
            {
                ...
                if (listEditor != null)
                {
                    ...
                    //listEditor.Grid.Styles.RowHotTrack = true;
                    gridControl.SettingsBehavior.EnableRowHotTrack = true;
                    ...
                    foreach (var gleColumn in listEditor.Columns.OfType<ASPxGridViewColumnWrapper>())
                    {
                        if (IsNonPersistentProperty(gleColumn.PropertyName))
                        {
                            DisableFilteringOnColumn(gleColumn);
                        }
                    }
        ...
        void DisableFilteringOnColumn(ASPxGridViewColumnWrapper column)
        {
            column.Column.Settings.AllowAutoFilter = DefaultBoolean.False;
            column.Column.Settings.AllowHeaderFilter = DefaultBoolean.False;
            column.Column.Settings.ShowInFilterControl = DefaultBoolean.False;
        }

        bool IsNonPersistentProperty(string propertyName)
        {
            switch (propertyName)
            {
                case "PropertyCreatedAtRuntime":
                case "NonPersistentProperty":
                    return true;
