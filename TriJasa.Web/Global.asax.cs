...
namespace TriJasa.Web {
    public class Global : System.Web.HttpApplication {
        ...
        protected void Application_Start(Object sender, EventArgs e) {
            ...
            XafPopupWindowControl.DefaultWidth = Unit.Percentage(95);
            ...
            // add for postgress
            Module.Controllers.PostgreSqlConnectionProviderEx.Register();
        ...
        protected void Session_Start(Object sender, EventArgs e) {
            Tracing.Initialize();
            WebApplication.SetInstance(Session, new TriJasaAspNetApplication());
