...
namespace TriJasa.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class TriJasaAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private TriJasa.Module.TriJasaModule module3;
        private TriJasa.Module.Web.TriJasaAspNetModule module4;
        ...
        public TriJasaAspNetApplication() {
            InitializeComponent();
        }
        //public override IObjectSpace GetObjectSpaceToShowDetailViewFrom(Frame sourceFrame, Type objectType)
        //{
        //    if (sourceFrame is NestedFrame)
        //    {
        //        return CreateObjectSpace();
        //    }
        //    else
        //    {
        //        return base.GetObjectSpaceToShowDetailViewFrom(sourceFrame, objectType);
        //    }
        //}
        ...
        {
            if (sourceFrame.View != null)
            {
                if (sourceFrame.View.Id == "DaftarMuatan_SuratMuatan_ListView_Entry" && objectType == typeof(SuratMuatan))
                {
                    return sourceFrame.View.ObjectSpace;
                }
                if (sourceFrame.View.Id == "SuratMuatan_SuratMuatDtl_ListView_Entry" && objectType == typeof(SuratMuatDtl))
                {
                    return sourceFrame.View.ObjectSpace;
                }
                //if (sourceFrame.View.Id == "JobEstimateDetail_JobEstimateResources_ListView" && objectType == typeof(JobEstimateResource))
                //{
                //    return sourceFrame.View.ObjectSpace;
                //}
            }
        ...
        private void TriJasaAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new TriJasa.Module.TriJasaModule();
            this.module4 = new TriJasa.Module.Web.TriJasaAspNetModule();
            ...
            // 
            // TriJasaAspNetApplication
            // 
            this.ApplicationName = "TriJasa";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.TriJasaAspNetApplication_DatabaseVersionMismatch);
