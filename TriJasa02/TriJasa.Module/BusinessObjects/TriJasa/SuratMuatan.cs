    ...
    private DateTime _Tanggal; 
     ...
     { 
       ...
       set { SetPropertyValue("TotalM3", ref _TotalM3, value); } 
        ...
        //[Persistent("TotalJml")]
        //private double? _TotalJml = null;
        //[PersistentAlias(nameof(_TotalJml))]
        //[IsHide(true)]
        //public double? TotalJml
        //{
        //    get
        //    {
        //        if (!IsLoading && !IsSaving && _TotalJml == null)
        //            UpdateTotalJumlah(false);
        //        return _TotalJml;
        //    }
        //}
